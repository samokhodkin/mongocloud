...
public class WebDavServletBean extends HttpServlet {
    ...
    public void init(
       IWebdavStore store, String dftIndexFile, String insteadOf404, 
...
//System.out.println("WebDavServletBean.service() req="+req+", princip.: "+req.getUserPrincipal());
...
//System.out.println("WebDavServletBean.service() userPrincipal = "+userPrincipal);
            ...
            //req.authenticate(resp); not working in jetty
            LOG.trace("requesting basic auth");
